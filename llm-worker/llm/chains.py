...
from llm.prompts import audio_status_prompt, audio_task_prompt, classifier_prompt, decision_prompt, file_summary_prompt, speaker_segments_prompt, status_prompt, status_query_prompt, sync_split_prompt, task_prompt
...
sync_split_chain = sync_split_prompt | _cheap | _safe_json
